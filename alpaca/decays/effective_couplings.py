...
from ..constants import mW, s2w, me, mmu, mtau, mc, mb, mu, md, ms, metap, fpi, mt, mb, mpi0, mK
...
def cgamma(ma: float, couplings: ALPcouplings, fa: float, **kwargs) -> complex:
    cgamma_eff = 0
    if ma > mW:
...
def cg(ma: float, couplings: ALPcouplings, **kwargs) -> complex:
    citations.register_inspire('Bauer:2017ris')
