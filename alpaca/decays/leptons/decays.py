...
lepton_to_alp = {
    ('tau', ('alp', 'muon')): lambda ma, couplings, fa, dark_matter, **kwargs: tau_mua(ma, couplings, fa, **kwargs)/Gammatau,
    ('tau', ('alp', 'electron')): lambda ma, couplings, fa, dark_matter, **kwargs: tau_ea(ma, couplings, fa, **kwargs)/Gammatau,
    ('muon', ('alp', 'electron')): lambda ma, couplings, fa, dark_matter, **kwargs: mu_ea(ma, couplings, fa, **kwargs)/Gammamu,
}
