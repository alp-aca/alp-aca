...
wolfRhoBar = Parameter(name = 'wolfRhoBar',
                       nature = 'external',
                       type = 'real',
                       value = 0.1591,
                       texname = '\\bar{\\rho}',
...
wolfEtaBar = Parameter(name = 'wolfEtaBar',
                       nature = 'external',
                       type = 'real',
                       value = 0.3523,
                       texname = '\\bar{\\eta}',
...
wolfRho = Parameter(name = 'wolfRho',
                    nature = 'internal',
                    type = 'real',
                    value = 'wolfRhoBar/(1 - wolfLambda**2/2.)',
                    texname = '\\text{wolfRho}')

wolfEta = Parameter(name = 'wolfEta',
                    nature = 'internal',
                    type = 'real',
                    value = 'wolfEtaBar/(1 - wolfLambda**2/2.)',
                    texname = '\\text{wolfEta}')

CKM1x1 = Parameter(name = 'CKM1x1',
                   nature = 'internal',
                   type = 'complex',
                   value = '1 - wolfLambda**2',
                   texname = '\\text{CKM1x1}')
